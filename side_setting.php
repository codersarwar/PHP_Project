    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="" method="post">
            ...
            <input type="color" class="form-control mt-1 mb-1" name="text_color" placeholder="Enter text_color">
             <input type="color" class="form-control mt-1 mb-1" name="bg_color" placeholder="Enter bg_color">
             <input type="color" class="form-control mt-1 mb-1" name="button_color" placeholder="Enter button_color">
             <input type="color" class="form-control mt-1 mb-1" name="bar_color" placeholder="Enter bar_color">
...
<th class="text-center">bar_color</th>
 <th class="text-center">font_logo</th>
	...
	<tr>
        ...
        <td style="background-color:<?php echo $row["text_color"]; ?>"><?php echo $row["text_color"]; ?></td>
        <td style="background-color:<?php echo $row["bg_color"]; ?>"><?php echo $row["bg_color"]; ?></td>
        <td style="background-color:<?php echo $row["button_color"]; ?>"><?php echo $row["button_color"]; ?></td>
        <td style="background-color:<?php echo $row["bar_color"]; ?>"><?php echo $row["bar_color"]; ?></td>
        ...
        <a href ="side_setting_edit.php?id=<?php echo $row["id"]; ?>"><button class="btn btn-info btn-sm">Edit</button></a>
		 <a href ="side_setting_delete.php?id=<?php echo $row["id"]; ?>"><button class="btn btn-danger btn-sm">Delete</button></a>
		</td>
	</tr>
	<?php } ?>
