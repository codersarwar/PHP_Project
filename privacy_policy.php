    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="" method="post">
            ...
            <input type="text" class="form-control mt-1 mb-1" name="privacy_policy" placeholder="Enter privacy_policy">
...
if(isset($_POST['submit'])){
    ...
    if(mysqli_query($found,"INSERT INTO `privacy_policy` (`id`, `privacy_policy`) VALUES (NULL, '$privacy')")){
...
<tr>
    <th>id</th>
    <th class="text-center">privacy_policy</th>  
</tr>
</thead>
	<tbody>
	...
	$sql=mysqli_query($found,"SELECT * FROM privacy_policy");
